...
def venues():
  ...
  for row in locations:
    ...
    #Recuperation de la liste de venue en foucntion de la la cité et le state
    list_venues = (Venue.query.filter(and_(Venue.city==row[0], Venue.state==row[1])).all())

    #Parcours de la liste de venues 
    i = 0
    venues = []
    ...
    #Envoie des données dans le tableau data
    data.append(
      {
        "city": row[0],
        "state": row[1],
